...
public class PaintBrushToolUI extends JPanel implements ChangeListener {
	...
	private static JSlider opacity_slider;
	...
	public PaintBrushToolUI() {
		...
		size_slider = new JSlider(1,30,5);
	...
	public static void copySlider(int red, int green, int blue) {
		red_slider.setValue(red);
		green_slider.setValue(green);
		blue_slider.setValue(blue);
		//System.out.println(red_slider.getValue() + " " + green_slider.getValue() + " " + blue_slider.getValue());
	}

	@Override
	public void stateChanged(ChangeEvent e) {
		PaintBrushTool.setSize(size_slider.getValue());
	...
	public static double getOpacityLevel() {
